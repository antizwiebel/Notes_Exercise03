...
namespace NotesExercise03_Peneder.ViewModels
{
    public class SettingsViewModel :ViewModelBase
    {
        ...
        public void Save()
        {
            ...
            _storageService.Write(nameof(_iDataService), _iDataService.GetAllNotes());
        }
        ...
        public void Load()
        {
            ...
            foreach (var note in _storageService.Read<List<Note>>(nameof(_iDataService), null))
            {
                _iDataService.SaveNote(note);
            }
